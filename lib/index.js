...
function(t,e,r){"use strict";var n=r(/*! @babel/runtime/helpers/interopRequireDefault */1);Object.defineProperty(e,"__esModule",{value:!0}),e.devLog=s,e.reducerInAction=l,e.default=function(t){var e,r=(0,c.default)({isDev:!1,reducer:l,initialState:{},actions:{},middleware:{devLog:s}},t),n=r.isDev,h=r.reducer,p=r.initialState,d=r.actions,y=r.middleware,v=f.default.createContext(),g={useContext:function(){return f.default.useContext(v)},actions:d,dispatch:void 0,state:p,initialState:p};e=y?function(t,e){var r=h(t,e);if(y)for(var o in y)y[o](n,t,r,e);return r}:h;return{Provider:function(t){var r=f.default.useReducer(e,p),n=(0,u.default)(r,2),c=n[0],s=n[1];g.dispatch||(g.dispatch=function(){var t=(0,a.default)(i.default.mark(function t(e){return i.default.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:if("function"!=typeof e){t.next=5;break}return t.next=3,e(s,g.state);case 3:t.next=6;break;case 5:s(e);case 6:case"end":return t.stop()}},t,this)}));return function(e){return t.apply(this,arguments)}}());return g.state=c,f.default.createElement(v.Provider,(0,o.default)({},t,{value:c}))},store:g}};var o=n(r(/*! @babel/runtime/helpers/extends */2)),i=n(r(/*! @babel/runtime/regenerator */3)),a=n(r(/*! @babel/runtime/helpers/asyncToGenerator */6)),u=n(r(/*! @babel/runtime/helpers/slicedToArray */7)),c=n(r(/*! @babel/runtime/helpers/objectSpread */11)),f=n(r(/*! react */13));function s(t,e,r,n){t&&(console.log("%c|------- redux: ".concat(n.type," -------|"),"background: rgb(70, 70, 70); color: rgb(240, 235, 200); width:100%;"),console.log("|--last:",e),console.log("|--next:",r))}function l(t,e){return"function"==typeof e.reducer?e.reducer(t):t}},
/*!**********************************************************************!*\
