...
function(t,e,r){"use strict";var n=r(/*! @babel/runtime/helpers/interopRequireWildcard */1),o=r(/*! @babel/runtime/helpers/interopRequireDefault */2);Object.defineProperty(e,"__esModule",{value:!0}),e.devLog=function(t,e,r){console.info("%c|------- redux: ".concat(t," -------|"),s),console.info("|--last:",e),console.info("|--next:",r)},e.reducerInAction=function(t,e){if(e.callback){var r=e.callback(t);return r}return t},e.default=function(t){var e,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2?arguments[2]:void 0;function t(t,e){if(e.reducer){var r=e.reducer(t);if(n)for(var o in n)n[o](e.type,t,r);return r}return t}e=n?function(e,r){var o=t(e,r);if(n)for(var i in n)n[i](r.type,e,o);return o}:t;var o=(0,f.createContext)(),s={useContext:function(){return(0,f.useContext)(o)},dispatch:void 0,state:r,initialState:r};return{Provider:function(t){var n=(0,f.useReducer)(e,r),l=(0,c.default)(n,2),h=l[0],p=l[1];s.dispatch||(s.dispatch=function(){var t=(0,u.default)(a.default.mark(function t(e){return a.default.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:if("function"!=typeof e){t.next=5;break}return t.next=3,e(p,s.state);case 3:t.next=6;break;case 5:p(e);case 6:case"end":return t.stop()}},t,this)}));return function(e){return t.apply(this,arguments)}}());return s.state=h,f.default.createElement(o.Provider,(0,i.default)({},t,{value:h}))},store:s}};var i=o(r(/*! @babel/runtime/helpers/extends */3)),a=o(r(/*! @babel/runtime/regenerator */4)),u=o(r(/*! @babel/runtime/helpers/asyncToGenerator */7)),c=o(r(/*! @babel/runtime/helpers/slicedToArray */8)),f=n(r(/*! react */12)),s="background: rgb(70, 70, 70); color: rgb(240, 235, 200); width:100%;"},
/*!***********************************************************************!*\
