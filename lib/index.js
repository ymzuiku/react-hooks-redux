...
function(e,t,r){"use strict";var o=r(/*! @babel/runtime/helpers/interopRequireDefault */1);Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:v,t=(0,u.default)({},v,e),r=t.isDev,o=t.reducer,f=t.initialState,s=t.middleware,b=t.autoSave,y=l.default.createContext(),m={isDev:r,_state:f,useContext:function(){return l.default.useContext(y)},subscribe:d,dispatch:void 0,getState:function(){return m._state},onload:[],initialState:f},S=!1,h=function(e,t){var r=o(e,t);if(!S){if("[object Array]"!==Object.prototype.toString.call(s))throw new Error("react-hooks-redux: middleware isn't Array");S=!0}for(var n=0;n<s.length;n++){var a=s[n](m,e,r,t);a&&(r=a)}return m._state=r,p(t,r),r};b&&b.item&&g(m,b.item,b.keys);return{Provider:function(e){var t=l.default.useReducer(h,f),r=(0,c.default)(t,2),o=r[0],u=r[1];m.dispatch||(m.dispatch=function(){var e=(0,i.default)(a.default.mark(function e(t){return a.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if("function"!=typeof t){e.next=5;break}return e.next=3,t(u,m._state);case 3:e.next=6;break;case 5:u(t);case 6:case"end":return e.stop()}},e,this)}));return function(t){return e.apply(this,arguments)}}());return l.default.useEffect(function(){for(var e=0;e<m.onload.length;e++)m.onload[e]()},[]),l.default.createElement(y.Provider,(0,n.default)({},e,{value:o}))},store:m}},t.autoSaveLocalStorage=g,t.middlewareLog=y,t.middlewareImmutableLog=m,t.storage=void 0;var n=o(r(/*! @babel/runtime/helpers/extends */2)),a=o(r(/*! @babel/runtime/regenerator */3)),i=o(r(/*! @babel/runtime/helpers/asyncToGenerator */4)),c=o(r(/*! @babel/runtime/helpers/slicedToArray */5)),u=o(r(/*! @babel/runtime/helpers/objectSpread */6)),l=o(r(/*! react */7));var f={},s=0;function d(e){if("function"!=typeof e)throw new Error("react-hooks-redux: subscribe params need a function");return f[++s]=e,function(){delete f[s]}}function p(e,t){for(var r in f)f[r](t)}var v={isDev:!1,reducer:function(e,t){return"function"==typeof t.reducer?t.reducer(e):e},initialState:{},middleware:[y],autoSave:{item:void 0,keys:[]}};var b={localName:"defaultIOKey",save:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:b.localName,r=Object.prototype.toString.call(e);"[object Object]"===r?localStorage.setItem(t,JSON.stringify(e)):"[object String]"===r?localStorage.setItem(t,e):console.warn("Warn: storage.save() param is no a Object")},load:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:b.localName;try{var t=localStorage.getItem(e);if(t)return"string"==typeof t?JSON.parse(t):t}catch(e){console.warn("load last localSate error")}},clear:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:b.localName;localStorage.setItem(e,{})}};function g(e,t,r){t&&(b.localName=t),"[object Array]"!==Object.prototype.toString.call(r)&&console.warn("autoSaveStorageKeys: params is no a Array");var o=b.load(b.localName);"[object Object]"===Object.prototype.toString.call(o)&&e.onload.push(function(){e.dispatch({type:"localStorageLoad: IO",reducer:function(e){if(e&&e.toJS){var t=(0,u.default)({},e.toJS(),o);for(var r in t)e=e.set(r,t[r]);return e}return(0,u.default)({},e,o)}})});var n={};r.forEach(function(e){n[e]=void 0}),e.subscribe(function(){var t=e.getState();if(t&&t.toJS){var o={},a=!1;r.forEach(function(e){"[object Array]"===Object.prototype.toString.call(e)?o[e]=t.getIn(e):o[e]=t.get(e),n[e]!==o[e]&&(a=!0),n[e]=o[e]}),a&&b.save(o)}else{var i={},c=!0;r.forEach(function(e){i[e]=t[e],n[e]!==i[e]&&(c=!0),n[e]=i[e]}),c&&b.save(i)}})}function y(e,t,r,o){e.isDev&&(r&&"function"==typeof r.toJS?m(e,t,r,o):(console.log("%c|------- redux: ".concat(o.type," -------|"),"background: rgb(70, 70, 70); color: rgb(240, 235, 200); width:100%;"),console.log("|--last:",t),console.log("|--next:",r)))}function m(e,t,r,o){if(e.isDev){var n=function(e,t){var r={},o={};return t.map(function(n,a){var i=e.get(a);if(i!==n)if("[object Object]"===Object.prototype.toString.call(i))for(var c in r[a]={},n){var u=e.getIn([a,c]),l=t.getIn([a,c]);u!==l&&(r[a][c]=l)}else r[a]=n;o[a]=n}),[r,o]}(t,r);console.log("%c|------- redux: ".concat(o.type," -------|"),"background: rgb(70, 70, 70); color: rgb(240, 235, 200); width:100%;"),console.log("|--diff:",n[0]),console.log("|--merge:",n[1])}}t.storage=b},
/*!***************************************************************!*\
