...
function(t,e,r){"use strict";var n=r(/*! @babel/runtime/helpers/interopRequireWildcard */1),o=r(/*! @babel/runtime/helpers/interopRequireDefault */2);Object.defineProperty(e,"__esModule",{value:!0}),e.devLog=p,e.reducerInAction=h,e.default=function(t){var e,r=(0,f.default)({isDev:!1,reducer:h,initialState:{},actions:{},middleware:{devLog:p}},t),n=r.isDev,o=r.reducer,l=r.initialState,y=r.actions,d=r.middleware,v=(0,s.createContext)(),g={useContext:function(){return(0,s.useContext)(v)},actions:y,dispatch:void 0,state:l,initialState:l};e=d?function(t,e){var r=o(t,e);if(d)for(var i in d)d[i](n,t,r,e);return r}:o;return{Provider:function(t){var r=(0,s.useReducer)(e,l),n=(0,c.default)(r,2),o=n[0],f=n[1];g.dispatch||(g.dispatch=function(){var t=(0,u.default)(a.default.mark(function t(e){return a.default.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:if("function"!=typeof e){t.next=5;break}return t.next=3,e(f,g.state);case 3:t.next=6;break;case 5:f(e);case 6:case"end":return t.stop()}},t,this)}));return function(e){return t.apply(this,arguments)}}());return g.state=o,s.default.createElement(v.Provider,(0,i.default)({},t,{value:o}))},store:g}};var i=o(r(/*! @babel/runtime/helpers/extends */3)),a=o(r(/*! @babel/runtime/regenerator */4)),u=o(r(/*! @babel/runtime/helpers/asyncToGenerator */7)),c=o(r(/*! @babel/runtime/helpers/slicedToArray */8)),f=o(r(/*! @babel/runtime/helpers/objectSpread */12)),s=n(r(/*! react */14)),l="background: rgb(70, 70, 70); color: rgb(240, 235, 200); width:100%;";function p(t,e,r,n){t&&(console.log("%c|------- redux: ".concat(n.type," -------|"),l),console.log("|--last:",e),console.log("|--next:",r))}function h(t,e){return e.reducer?e.reducer(t):t}},
/*!***********************************************************************!*\
